...
class MlpMixerConfig(BaseConfig):
    ...
    lr_warmup_epochs: int = 35


Mixer_B_config = MlpMixerConfig(num_epochs=300, num_classes=1000, num_mixer_layers=12, hidden_size=768,
                                mlp_channel_dim=3072, mlp_token_dim=384)
...
Mixer_L_config = MlpMixerConfig(num_epochs=300, num_classes=1000, num_mixer_layers=24, hidden_size=1024,
                                mlp_channel_dim=4096, mlp_token_dim=512)
